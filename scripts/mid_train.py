...
parser.add_argument(
    "--init-lr-frac", type=float, default=1.0, help="initial LR as fraction of base LR"
)
# Evaluation
parser.add_argument(
    "--eval-every",
...
# Check for JayJun identity file first, fallback to original
...
train_tasks = [
    ...
    ),  # identity conversations (nanochat or JayJun)
